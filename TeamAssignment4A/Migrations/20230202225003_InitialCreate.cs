        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
<<<<<<<< HEAD:TeamAssignment4A/Migrations/20230202135103_test.cs
...
========
                    CertificateId = table.Column<int>(type: "int", nullable: false)
>>>>>>>> pr/28:TeamAssignment4A/Migrations/20230202225003_InitialCreate.cs
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateExamStems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CandidateExamStems_CandidateExams_CandidateExamId",
